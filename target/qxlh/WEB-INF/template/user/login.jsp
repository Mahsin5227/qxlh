                ...
                <div class="layui-form layui-tab-content" id="LAY_ucm" style="padding: 20px 0;">
                    <div class="layui-tab-item layui-show">
                        <div class="layui-form layui-form-pane">
                            <form class="layui-form" id="qxlh_login_form" action="${basePath}/user/login" method="post">
                                ...
                                <div>
                                    ...
                                    <input name="rememberme" type="checkbox" id="flag" value="1"  lay-skin="primary"> 记住密码
                                </div>
