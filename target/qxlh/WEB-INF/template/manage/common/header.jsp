...
<ul class="layui-nav" lay-filter="">
    <li class="layui-nav-item"><a href="${basePath}/manage/index">首页</a></li>
    <li class="layui-nav-item"><a href="${basePath}/manage/news/index">新闻公告</a>

        <dl class="layui-nav-child">
            <dd><a href="${basePath}/manage/news/add">添加</a></dd>
        ...
        <dl class="layui-nav-child">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <c:if test="${user.isAdmin}!=0"><dd><a href="/manage/news/index">信息管理</a></dd></c:if>
